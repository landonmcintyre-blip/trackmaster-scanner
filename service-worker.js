const CACHE_NAME = "trackmaster-shell-v28.3-portrait-pwa";
...
const APP_FILES = [
  APP_SCOPE,
  INDEX_URL,
  new URL("manifest.webmanifest?v=28.3", APP_SCOPE).href,
  new URL("style.css?v=28.3", APP_SCOPE).href,
  new URL("scanner.js?v=28.3", APP_SCOPE).href,
  ZXING_URL
];
