const CACHE_NAME = "trackmaster-shell-v29.1.1-sync-fix";
...
const APP_FILES = [
  APP_SCOPE,
  INDEX_URL,
  new URL("manifest.webmanifest?v=29.1.1", APP_SCOPE).href,
  new URL("style.css?v=29.1.1", APP_SCOPE).href,
  new URL("scanner.js?v=29.1.1", APP_SCOPE).href,
  ZXING_URL
];
